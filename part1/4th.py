...
def first():
    ...
    #Ввод
    entry=tk.Entry(window, fg="white", bg="black", width=100, show='*')
    # show скрывает написанное для пользователя указанным символов,
    # но при этом понимает написанное c клавиатуры 
    entry.pack()
